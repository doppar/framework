<div id="single-accordion-container" class="dark:bg-neutral-900 bg-neutral-900/[1%]">
  <div
  ...
  >
    ...
    >
      ...
      <svg
        class="accordion-arrow w-5 h-5 text-neutral-400 transition-transform duration-200 shrink-0"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
        aria-hidden="true"
    ...
    <div
      class="accordion-content bg-neutral-50/50 dark:bg-neutral-950/50 border-t border-neutral-200 dark:border-neutral-800 hidden"
      role="region"
    ...
    >
      <div class="p-3 font-mono text-xs">
        ...
        <div class="header flex gap-4 dark:text-neutral-400 text-neutral-700 items-center">
          ...
          <div class="flex-1 dark:border-white/10 border-neutral-900/10 border border-dashed h-[1px]"></div>
