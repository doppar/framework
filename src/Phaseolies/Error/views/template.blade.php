    ...
    <div class="top-bar rounded-lg">
        <div
            ...
            <div class="ml-auto flex flex-col">
                ...
                <!-- versions -->
                <div
                    class="rounded-md flex border-[1.2px] dark:bg-white/[1%] bg-neutral-900/[1%]  text-sm py-1 bg-white/2 border-neutral-900/4 px-2 mt-4 dark:border-white/4">
