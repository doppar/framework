...
<body
    ...
    <div class="container py-4">
        <div class="flex justify-end mb-4">
            <button
                id="themeToggle"
                class="p-2 cursor-pointer rounded-lg bg-neutral-800/5 dark:bg-white/5 hover:bg-neutral-800/6 dark:hover:bg-white/6 transition-colors border dark:border-white/15 border-neutral-900/10"
