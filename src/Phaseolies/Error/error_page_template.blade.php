    ...
    <body>
        <div class="container py-4">
            <div class="mb-4 d-flex justify-content-between align-items-start">
                <div class="card w-100">
                    <div class="card-body d-flex justify-content-between align-items-start top-block">
                        <div>
                        ...
                        <div class="logo">
                            <a href="https://doppar.com" class="ms-3">
                                <img src="https://doppar.com/logo.png" alt="Doppar" height="24" />
                            </a>
                            <span id="theme-toggle"
                                class="btn btn-sm btn-outline-secondary d-flex align-items-center justify-content-center"
                                style="border-radius: 50px; width: 15px; height: 2px;">
                                <i id="theme-icon" class="fas fa-moon"></i>
                            </span>
                            <span id="copy-top-block" class="d-flex align-items-center justify-content-center copy-icon mt-3 ms-2"
                        ...
                        <div class="code-header">
                            ...
                            <div>
                                <span class="badge bg-danger d-inline-flex align-items-center px-3 py-2"
                                    style="font-size: 0.8rem; font-weight: 500; border-radius: 6px;">
                                    <i class="fas fa-exclamation-circle me-2" style="font-size: 0.7rem;"></i>Line
                                    {{ error_line }}
                                </span>
                            </div>
                        </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const copyBtn = document.getElementById("copy-top-block");
                ...
                copyBtn.addEventListener("click", () => {
                    ...
                    const textToCopy = topBlock.innerText.trim();
